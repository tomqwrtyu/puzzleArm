...
(cl:defmethod cl:initialize-instance :after ((m <num_state-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'num_state-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cam-srv:<num_state-request> is deprecated: use cam-srv:num_state-request instead.")))

(cl:ensure-generic-function 'num_state-val :lambda-list '(m))
(cl:defmethod num_state-val ((m <num_state-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cam-srv:num_state-val is deprecated.  Use cam-srv:num_state instead.")
  (num_state m))
...
(cl:defmethod cl:initialize-instance :after ((m <num_state-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'num_state-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cam-srv:<num_state-response> is deprecated: use cam-srv:num_state-response instead.")))
