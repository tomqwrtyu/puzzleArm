...
if("TRUE" STREQUAL "TRUE")
  set(arm_SOURCE_PREFIX /home/nvidia/puzzleArm/src/arm)
  set(arm_DEVEL_PREFIX /home/nvidia/puzzleArm/devel)
  set(arm_INSTALL_PREFIX "")
  set(arm_PREFIX ${arm_DEVEL_PREFIX})
else()
  set(arm_SOURCE_PREFIX "")
  set(arm_DEVEL_PREFIX "")
  set(arm_INSTALL_PREFIX /home/nvidia/puzzleArm/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'arm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/puzzleArm/src/arm/${idir}'.  ${_report}")
    endif()
